...
-- Tables référencées plus bas mais créées par aucune migration précédente :
-- sans ces CREATE, l'exécution des migrations dans l'ordre numérique échoue
-- dès le premier ALTER TABLE ci-dessous.
